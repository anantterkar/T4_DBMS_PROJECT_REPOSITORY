...
ADD FOREIGN KEY (AGREEMENT_ID) REFERENCES T4_Insurance_Policy(AGREEMENT_ID); -- probably a mistake...... blame teammates -- FIXED IT
...
-- YAAAYYYYYYY, IM DONEEEEEEEEEEE. OwO
-- HAA KHUD HI KARLE SAB BAKI LOG KO TO INFORM KARNA BHI JARURI NAHI HE . GOOD
